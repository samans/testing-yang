...
expect ">"
send "load ieee802-dot1ae-secy\r"
expect ">"
send "load ieee802-dot1ae-pry\r"
expect ">"
send "load ieee802-dot1x-eapol\r"
expect ">"
...
send "data -t data -f json basic-vlan-bridge-with-pry-test.xml\r"
expect ">"
send "data -t data -f json basic-vlan-bridge-with-pry-test.xml -o basic-vlan-bridge-with-pry-test.json\r"
expect ">"
send "quit\r"
expect eof

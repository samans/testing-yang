...
send "data -t data -f json -d all basic-vlan-bridge-with-pry-data.xml\r"
expect ">"
send "data -t data -f json -d all basic-vlan-bridge-with-pry-data.xml -o basic-vlan-bridge-with-pry-data.json\r"
expect ">"
send "quit\r"
expect eof

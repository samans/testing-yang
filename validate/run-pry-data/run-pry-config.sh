...
send "data -t config -f json -d all basic-vlan-bridge-with-pry-config.xml\r"
expect ">"
send "data -t config -f json -d all basic-vlan-bridge-with-pry-config.xml -o basic-vlan-bridge-with-pry-config.json\r"
expect ">"
send "quit\r"
expect eof
